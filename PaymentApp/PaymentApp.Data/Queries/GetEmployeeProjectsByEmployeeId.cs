...
{
    public class GetEmployeeProjectsByEmployeeId : IExecuteDataRequestAsync<int, List<ListEmployeeProjects>>
    {

        private readonly PaymentAppDbContextQuery _PaymentAppDbContextQuery;
        private readonly IMapper _mapper;

        public GetEmployeeProjectsByEmployeeId(PaymentAppDbContextQuery PaymentAppDbContextQuery, IMapper mapper)
        {
